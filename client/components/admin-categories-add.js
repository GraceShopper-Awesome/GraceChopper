...
import { fetchAllCategories, addCategoryToDatabase, removeCategoryFromDatabase } from '../store';
		...
		return (
			<div>
				...
				<form onSubmit={event => this.handleSubmit(event)}>
					<input type="text" value={this.state.value} onChange={event => this.handleChange(event)} name="categoryName" />
